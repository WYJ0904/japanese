...
class StaticSiteTests(unittest.TestCase):
    ...
    def test_manifest_and_service_worker_shell_are_deployable(self):
        ...
        release_token = "20260728-launcher-stability"
        ...
        self.assertIn('const APP_VERSION = "2026-07-28-launcher-stability"', self.app)
        server = (ROOT / "local-backend" / "server.py").read_text(encoding="utf-8")
        self.assertIn('APP_BUILD = "2026-07-28-launcher-stability"', server)
    ...
    def test_branding_and_launcher_contract(self):
        ...
        self.assertIn('$LauncherVersion = "10.2.0"', launcher)
        self.assertIn("Get-TunnelHaConnections", launcher)
        self.assertIn("-AcceptHealthyConnector", launcher)
        ...
        self.assertIn('$WatchdogVersion = "3.1.0"', watchdog)
        self.assertIn("Get-TunnelHaConnections", watchdog)
        self.assertIn("$publicOk -or $connectorOk", watchdog)
        ...
        self.assertIn("Wait-ForBackendStartup", launcher)
