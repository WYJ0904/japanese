...
class StaticSiteTests(unittest.TestCase):
    ...
    def test_branding_and_launcher_contract(self):
        ...
        watchdog = (ROOT / "desktop-tools" / "watch-wyj.ps1").read_text(encoding="utf-8")
        backend_runner = (ROOT / "local-backend" / "run.ps1").read_text(encoding="utf-8")
        ...
        self.assertIn('$LauncherVersion = "10.0.0"', launcher)
        ...
        self.assertNotIn("_wyj-tools", launcher_cmd)
        self.assertNotIn("-NonInteractive", launcher_cmd)
        self.assertIn('"Local\\WYJWebsiteWatchdogV1"', watchdog)
